...
public final class ItemHistoryBinding implements ViewBinding {
  ...
  private ItemHistoryBinding(@NonNull CardView rootView, @NonNull TextView tvBloodGroup,
      @NonNull TextView tvDate, @NonNull TextView tvIndex, @NonNull TextView tvLocation,
      @NonNull TextView tvRecipient) {
    this.rootView = rootView;
    this.tvBloodGroup = tvBloodGroup;
    this.tvDate = tvDate;
    this.tvIndex = tvIndex;
    this.tvLocation = tvLocation;
    this.tvRecipient = tvRecipient;
  }
  ...
  public static ItemHistoryBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tvRecipient;
      TextView tvRecipient = ViewBindings.findChildViewById(rootView, id);
      if (tvRecipient == null) {
        break missingId;
      }

      return new ItemHistoryBinding((CardView) rootView, tvBloodGroup, tvDate, tvIndex, tvLocation,
          tvRecipient);
    }
